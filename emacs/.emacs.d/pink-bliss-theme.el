...
;; Copyright (C) 2020 Eugene Sharygin <eush77@gmail.com>
...
(custom-theme-set-faces
 ...
 '(region ((((min-colors 256)) (:background "purple" :foreground "misty rose"))))
 '(highlight ((((min-colors 256)) (:background "purple" :foreground "misty rose"))))
 '(cursor ((((min-colors 256)) (:background "hot pink" :foreground "magenta4"))))
 '(widget-field ((((min-colors 256)) (:extend t :foreground "magenta4" :underline t))))
 ;; isearch
 ...
 ;; custom
 '(custom-button (((min-colors 256) (:background "hot pink" :foreground "magenta4" :box (:line-width 2 :style released-button)))))
 '(custom-button-mouse (((min-colors 256) (:background "purple" :foreground "misty rose" :box (:line-width 2 :style released-button)))))
 '(custom-button-pressed (((min-colors 256) (:background "purple" :foreground "misty rose" :box (:line-width 2 :style pressed-button)))))
 ;; w3m
 '(w3m-anchor ((((min-colors 256)) (:foreground "deep pink" :underline t :weight bold))))
 '(w3m-arrived-anchor ((((min-colors 256)) (:foreground "violet red" :underline t :weight bold))))
 '(w3m-current-anchor ((((min-colors 256)) (:underline (:color "purple" :style wave)))))
 '(w3m-form ((((min-colors 256)) (:foreground "magenta4" :underline t))))
 '(w3m-form-button ((((min-colors 256)) (:background "hot pink" :foreground "magenta4" :box (:line-width 2 :style released-button)))))
 '(w3m-form-button-mouse ((((min-colors 256)) (:background "purple" :foreground "misty rose" :box (:line-width 2 :style released-button)))))
 '(w3m-form-button-pressed ((((min-colors 256)) (:background "purple" :foreground "misty rose" :box (:line-width 2 :style pressed-button)))))
 '(w3m-header-line-content ((((min-colors 256)) (:background "pink" :foreground "magenta4" :box (:line-width 2 :color "magenta4" :style released-button)))))
 '(w3m-header-line-title ((((min-colors 256)) (:background "pink" :foreground "magenta4" :box (:line-width 2 :color "magenta4" :style released-button) :weight bold))))
 '(w3m-image ((((min-colors 256)) (:background "hot pink" :foreground "purple" :box (:line-width 2 :color "purple" :style pressed-button)))))
 '(w3m-image-anchor ((((min-colors 256)) (:background "hot pink" :foreground "purple" :box (:line-width 2 :color "purple" :style pressed-button)))))
 '(w3m-lnum ((((min-colors 256)) (:foreground "purple"))))
 '(w3m-lnum-match ((((min-colors 256)) (:background "purple" :foreground "misty rose"))))
 '(w3m-lnum-minibuffer-prompt ((((min-colors 256)) nil)))
 '(w3m-tab-background ((((min-colors 256)) (:background "pink"))))
 '(w3m-tab-mouse ((((min-colors 256)) (:box (:line-width 3 :style released-button)))))
 '(w3m-tab-selected ((((min-colors 256)) (:background "hot pink" :foreground "magenta4" :box (:line-width -1 :style released-button)))))
 '(w3m-tab-selected-background ((((min-colors 256)) (:background "hot pink" :foreground "magenta4" :box (:line-width -1 :style released-button) :weight bold))))
 '(w3m-tab-selected-retrieving ((((min-colors 256)) (:background "hot pink" :foreground "purple" :box (:line-width -1 :style released-button)))))
 '(w3m-tab-unselected ((((min-colors 256)) (:background "pink" :foreground "magenta4" :box (:line-width -1 :style released-button)))))
 '(w3m-tab-unselected-retrieving ((((min-colors 256)) (:background "pink" :foreground "purple" :box (:line-width -1 :style released-button)))))
 '(w3m-tab-unselected-unseen ((((min-colors 256)) (:background "pink" :foreground "magenta4" :box (:line-width -1 :style released-button) :weight bold))))
 )
